          ...
          <div className={classes.loandgrantcards}>
            ...
            <div className={classes.loandethead}>
              ...
              <div className={classes.formIntBtn}>
                <Button variant="success" onClick={handleShow} className={classes.btn2}> Add New Service</Button>
              </div>
            </div>
            <Modal show={show} onHide={handleClose} animation={false}>
                    ...
                    {loading ? (
                      <>
                      <Spinner  size='sm' /> 
                      <span style={{ marginLeft: '5px' }}>Creating Service, Please wait...</span>
    </>
  ) : (
                "Create Service"
                      )}
