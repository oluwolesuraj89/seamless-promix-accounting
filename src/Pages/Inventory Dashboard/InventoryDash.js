                    ...
                    <Accordion>
                        ...
                        <Card className={classes.accordionCard}>
                            ...
                            <Accordion.Collapse eventKey="0" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                    <NavLink to={'/inventory/unit_of_measurement'} >Unit of Measurement</NavLink><br/>
                        ...
                        {/* <Card className={classes.accordionCard}>
                            ...
                            <Accordion.Collapse eventKey="6" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                <Link to={'/inventory/services'}>Manage Services</Link><br/>
                                </Card.Body>
                        ...
                        <Card className={classes.accordionCard}>
                            ...
                            <Accordion.Collapse eventKey="6" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                <Link to={'/inventory/products'}>Products/List Items</Link><br/>
                                </Card.Body>
                        ...
                        <Card className={classes.accordionCard}>
                            <Card.Header className={classes.cardHeader} onClick={toggleMenu1}>
                                <ContextAwareToggle eventKey="1">
                                    <p>
                                        <span><img src={dIcon2} alt='icon' /> Sales</span>
                            ...
                            <Accordion.Collapse eventKey="1" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                    <Link to={'/inventory/customers'}>Customers</Link><br/>
                                    <Link to={'/inventory/sales_invoice'}>Sales Invoices</Link><br/>
                                </Card.Body>
                        ...
                        <Card className={classes.accordionCard}>
                            <Card.Header className={classes.cardHeader} onClick={toggleMenu1}>
                                <ContextAwareToggle eventKey="12">
                                    <p>
                                        <span><img src={dIcon2} alt='icon' /> Purchases</span>
                                        {isMenuOpen1 ? (<i class='bx bx-chevron-down'></i>) : (<i class='bx bx-chevron-up'></i>)} 
                                    </p>
                                </ContextAwareToggle>
                            </Card.Header>
                            <Accordion.Collapse eventKey="12" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                    ...
                                    <Link to={'/inventory/suppliers'}>Suppliers</Link><br/>
                                    <Link to={'/inventory/purchase_invoices'}>Purchase Invoices</Link><br/>
                                </Card.Body>
                        ...
                        <Card className={classes.accordionCard}>
                            ...
                            <Accordion.Collapse eventKey="2" style={{backgroundColor:'#164B2E'}}>
                                <Card.Body className={classes.cardBody}>
                                    <Link to={'/inventory/requisition'}>Requistion List</Link><br/>
