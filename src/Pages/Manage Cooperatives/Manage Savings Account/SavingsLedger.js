...
import classes from './SavingsLedger.module.css';
...
const fetchCustomerSavings = async (selectedCustomer) => {
  ...
  try {
      const response = await axios.get(
          `${BASE_URL}/account/fetch-member-savings?member_id=${selectedCustomer}`,
          {
              headers: {
                  'Content-Type': 'application/json',
                  Authorization: `Bearer ${bearer}`,
      ...
      const savingTypes = loanss.map(item => item.saving_type);
          ...
          <CoopDashboard />
            ...
            <div className={classes.topPadding}>
                    <div className={`${classes.formSecCont}`}>
                        <div className={classes.formSectionHeader}>
                            <h3>Savings Individual Ledger</h3>
            ...
            <div className={classes.topPadding}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="form-group row">
                                <label for="example-text-input" className="col-sm-3 col-form-label font-weight-400">Savings:</label>
                                <div className="col-sm-9">
                                <Select
...
<div>
                ...
                <button onClick={() => navigate('/cooperative/report_ledger', { state: { document: paidBooking, customer: selectedCustomerName, saving: selectedSavingsName, type: "SAVINGS" } })} style={{ height: 30, width: 130, borderRadius: 0,  backgroundColor: "#198754", color: "#fff", marginBottom: 10, marginTop: 10 }}>Print Report</button>
            )}
                              </div>
