...
import classes from './ApprovalLevel.module.css';
          ...
          <div className={classes.loandgrantcards}>
            ...
            <div className={classes.loandethead}>
              ...
              <div className={classes.formIntBtn}>
                <Button variant="success" onClick={handleCreate} className={classes.btn2}> Set New Approval Level</Button>
              </div>
            </div>
                            ...
                            {displayedData.map((item, index) => (
                              <tr style={{height: 30}} key={index}>
                               <td>{index + 1}</td>
                                ...
                                <td>
                                {(admin === "1" || permissions.includes('update-approval-level')) && (
...
{(admin === "1" || permissions.includes('delete-approval-level')) && (
